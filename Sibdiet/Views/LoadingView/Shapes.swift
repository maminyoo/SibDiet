...
//  Copyright © 2018 Application.Studio. All rights reserved.
//
...
//            let starPath = UIBezierPath()
            path.move(to: CGPoint(x: 81.5, y: 7.0))
            path.addLine(to: CGPoint(x: 101.07, y: 63.86))
            path.addLine(to: CGPoint(x: 163.0, y: 64.29))
            path.addLine(to: CGPoint(x: 113.16, y: 99.87))
            path.addLine(to: CGPoint(x: 131.87, y: 157.0))
            path.addLine(to: CGPoint(x: 81.5, y: 122.13))
            path.addLine(to: CGPoint(x: 31.13, y: 157.0))
            path.addLine(to: CGPoint(x: 49.84, y: 99.87))
            path.addLine(to: CGPoint(x: 0.0, y: 64.29))
            path.addLine(to: CGPoint(x: 61.93, y: 63.86))
            path.addLine(to: CGPoint(x: 81.5, y: 7.0))
